@auth
   ...
   <body class="bg-light">
      <div id="db-wrapper">
         <!-- navbar vertical -->
         <!-- Sidebar -->
         <nav class="navbar-vertical navbar" style="padding-top: 70px; background-color: #fff">
            <div class="nav-scroller">
               <!-- Navbar nav -->
               <ul class="navbar-nav flex-column" id="sideNavbar">
                  <li class="nav-item">
                     <a class="nav-link has-arrow {{ Request::is('/') ? 'active' : '' }}" href="/">
         ...
         <div id="page-content">
            <div class="header @@classList">
               ...
               <nav class="navbar-classic navbar navbar-expand-lg fixed-top">
                  <!-- Brand logo -->
                  <a class="navbar-brand pe-5 d-none d-md-block" href="/">
